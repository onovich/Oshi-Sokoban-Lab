...
def build(out):
    paint=mat('Robot bone armor',(.49,.445,.335),.32,.77)
    ...
    def plate(name,rings,bn,x=0,y=0,material=paint):
        o=panel(name,rings,material,.8);o.location.x=x;o.location.y=y;return P(o,bn)
    ...
    for o,bn in parts:
        ...
        mod=o.modifiers.new('Mechanical rigid skin','ARMATURE');mod.object=rig;o.parent=rig
