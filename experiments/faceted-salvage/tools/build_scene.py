...
(out/'manifest.json').write_text(json.dumps(dict(revision=3,generator=bpy.app.version_string,seed=701,actor='Original mesh; Humanoid T pose',bones=len(rig.data.bones),animations=['Idle','Walk','Push'],staticObjects=len(static),movableObjects=3,puzzleEngineConnected=False),indent=2))
...
print('REVISION 3 COMPLETE',flush=True)
